...
- `src/cert_ra/api/domain/web/controllers.py` - Simple page controllers
- `src/cert_ra/api/domain/accounts/controllers.py` - Full CRUD with auth

### Inertia Configuration

`src/cert_ra/api/lib/vite.py`:
...
mcp__deepwiki__ask_question(
    repoName="inertiajs/inertia",       # or: litestar-org/litestar-vite
    question="How does partial reloads work with `only` and `except`?"
)
```
...
- `src/cert_ra/api/domain/web/controllers.py` - Simple page controllers
- `src/cert_ra/api/domain/accounts/controllers.py` - Auth controllers with Inertia
