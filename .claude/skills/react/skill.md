...
mcp__deepwiki__ask_question(
    repoName="facebook/react",     # or: shadcn-ui/ui, tailwindlabs/tailwindcss
    question="How do I use the `use` hook with Suspense?"
)
```
...
- `resources/main.css` - Tailwind v4 CSS-first configuration
