...
from cert_ra.db.models import Team, User as UserModel
...
class AdminDashboardController(Controller):
    ...
    dependencies = {"audit_service": Provide(provide_audit_service)}  # noqa: RUF012
    ...
    async def dashboard(self, audit_service: AuditLogService) -> AdminDashboardPage:
        ...
        recent_logs_result, _ = await audit_service.list_and_count(
