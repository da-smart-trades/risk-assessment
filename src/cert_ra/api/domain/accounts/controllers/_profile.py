...
from cert_ra.api.domain.accounts.schemas import PasswordUpdate, ProfileUpdate, User
...
class ProfileController(Controller):
    ...
    async def profile(
        self, current_user: UserModel, users_service: UserService
    ) -> User:
    ...
    async def update_profile(
        self, current_user: UserModel, data: ProfileUpdate, users_service: UserService
    ) -> User:
    ...
    async def remove_account(
        ...
        flash(
            request, "Your account has been removed from the system.", category="info"
        )
