...
def schema_upgrades() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "totp_secret",
            sa.EncryptedString(key="secret-key", backend=FernetBackend, length=None),
            nullable=True,
    ...
    with op.batch_alter_table("audit_log", schema=None) as batch_op:
        ...
        batch_op.create_index(
            batch_op.f("ix_audit_log_target_id"), ["target_id"], unique=False
        )
        batch_op.create_index(
            batch_op.f("ix_audit_log_target_type"), ["target_type"], unique=False
        )
    ...
    with op.batch_alter_table("email_token", schema=None) as batch_op:
        batch_op.create_index(
            "ix_email_token_email_type", ["email", "token_type"], unique=False
        )
        batch_op.create_index("ix_email_token_hash", ["token_hash"], unique=False)
        batch_op.create_index(
            batch_op.f("ix_email_token_user_id"), ["user_id"], unique=False
        )
    ...
    with op.batch_alter_table("team_invitation", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_team_invitation_email"), ["email"], unique=False
        )
        batch_op.create_index(
            "ix_team_invitation_email_team", ["email", "team_id"], unique=False
        )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["tag_id"],
            ["tag.id"],
            name=op.f("fk_team_tag_tag_id_tag"),
            ondelete="CASCADE",
        ),
        sa.ForeignKeyConstraint(
            ["team_id"],
            ["team.id"],
            name=op.f("fk_team_tag_team_id_team"),
            ondelete="CASCADE",
        ),
    ...
    with op.batch_alter_table("user_account_oauth", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_user_account_oauth_account_id"), ["account_id"], unique=False
        )
        batch_op.create_index(
            batch_op.f("ix_user_account_oauth_oauth_name"), ["oauth_name"], unique=False
        )
